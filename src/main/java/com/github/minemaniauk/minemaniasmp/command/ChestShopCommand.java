...
import com.github.minemaniauk.minemaniasmp.inventory.ChestShopInventory;
import com.github.smuddgge.squishyconfiguration.interfaces.ConfigurationSection;
import org.jetbrains.annotations.NotNull;
import org.jetbrains.annotations.Nullable;

public class ChestShopCommand implements CommandType {
    ...
    public @Nullable String getDescription() {
        return "Opens the chest shop help menu.";
    }
    ...
    public @Nullable CommandStatus onPlayer(@NotNull PlayerUser user, @NotNull ConfigurationSection section, @NotNull CommandArguments arguments) {
        new ChestShopInventory().open(user.getPlayer());
